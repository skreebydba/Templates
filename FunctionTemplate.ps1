<#
.SYNOPSIS
  Name: DoSomething.ps1
  The purpose of this script is to do something using PowerShell.
  
.DESCRIPTION
  The purpose of this script is to do something using PowerShell.  I do not know what that is.  You will have to figure it out
  yourself.
